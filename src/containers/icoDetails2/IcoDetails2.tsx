          ...
          <table className="table-private-sale">
            <tbody>
              <tr style={{ background: '#392551' }}>
                <td className="color--green">{strings.privateSale}</td>
                <td />
                <td />
                <td>0 - 17.5</td>
                <td>{strings.millionCoinsOffered}</td>
                <td className="color--green">-70%</td>
                <td className="color--green">€ 0.03</td>
              </tr>
              <tr style={{ background: '#4c306a' }}>
                <td className="color--red">{strings.preSale}</td>
                <td>{strings.day} 1</td>
                <td>{strings.earlyBirds}</td>
                <td>17.5 - X</td>
                <td>{strings.millionCoinsOffered}</td>
              ...
              <tr style={{ background: '#392551' }}>
                <td className="color--purple">{strings.mainSale}</td>
                <td>{strings.day} 1</td>
                <td>{strings.earlyBirds}</td>
                <td>297.5 - X</td>
                <td>{strings.millionCoinsOffered}</td>
              ...
              <tr style={{ background: '#392551' }}>
                ...
                <td style={{ maxWidth: '200px' }}>
                  € 0.005 {strings.each24Hour} € 0.245
                </td>
                <td />
                <td />
              </tr>
              <tr style={{ background: '#4c306a' }}>
                <td className="color--cyan">{strings.lastChance}</td>
                <td />
                <td />
                <td>100</td>
                <td>{strings.millionCoinsOffered}</td>
